...
constexpr strict_bound adjoint_map_bound{5.3290705182007514e-15, 1e-13, bound_standing::tighter, bound_standing::at_the_platform};
...
constexpr strict_bound matrix_exponential_se3_bound{1.2031773569048783e-14, 1.1690601003778219e-14, bound_standing::tighter, bound_standing::tighter};
...
// at the platform, strictly over where it says above it.
inline void standing_matches(const strict_bound &bound, praxis::evaluation::residual_kind kind)
{
    const praxis::evaluation::tolerance_pair published = praxis::evaluation::tolerance_of(kind);
